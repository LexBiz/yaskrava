        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          {lockTopic ? (
            <label className="grid gap-1.5">
              ...
              <div className="h-12 rounded-2xl border border-gray-200 bg-gray-50 px-4 text-sm text-gray-800 flex items-center font-semibold">
                {topic === "VEHICLE" ? t("topicVehicle") : t("topicLeasing")}
              </div>
            </label>
          ) : (
            <label className="grid gap-1.5">
